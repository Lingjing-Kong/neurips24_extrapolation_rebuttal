...
class IMAGENET_(data.Dataset):
    def __init__(self, root_dir:str):
        ...
        self.transform = transforms.Compose([transforms.Resize((224, 224)),transforms.ToTensor(), transforms.Normalize(mean=self.mean, std=self.std)])
        self.dataset = torchvision.datasets.ImageNet(root_dir, split='val', transform=self.transform)
