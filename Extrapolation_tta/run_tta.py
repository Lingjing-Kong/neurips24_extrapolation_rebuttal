...
from utilities.utils import setup_experiment, str2bool
import warnings
...
def get_opt_parser():
    ...
    parser.add_argument("--exp", type=str, default="base")

    # lora
    parser.add_argument("--lora_lr_factor", type=float, default=1)
    parser.add_argument("--lora_rank", type=str, default="64")
    parser.add_argument("--ema_momentum_", type=float, default=0.9)
...
def test_time_adapt(opt: argparse.Namespace):
    print(opt)
...
if __name__ == "__main__":
    ...
    opt.experiment_dir = os.path.join(opt.experiment_dir)
    test_time_adapt(opt)
